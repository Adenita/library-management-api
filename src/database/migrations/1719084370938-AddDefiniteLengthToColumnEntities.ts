  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "author" ADD "name" character varying(100) NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "book" DROP COLUMN "title"`);
    await queryRunner.query(
      `ALTER TABLE "book" ADD "title" character varying(100) NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "book" DROP COLUMN "language"`);
    await queryRunner.query(
      `ALTER TABLE "book" ADD "language" character varying(30) NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "loan" DROP COLUMN "status"`);
    await queryRunner.query(
      `ALTER TABLE "loan" ADD "status" character varying(60) NOT NULL`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "author" DROP COLUMN "name"`);
    await queryRunner.query(
      `ALTER TABLE "author" ADD "name" character varying NOT NULL`,
    );
  }
}
